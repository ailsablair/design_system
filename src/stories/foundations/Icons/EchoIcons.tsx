...
// Material Design outline icons from Figma
export const EmoticonCoolOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
...
export const MessageBadgeOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const MapMarkerStarOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const MovieCogOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const StarPlusOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const PentagonOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
    <path d="M12 5L19.6 10.5L16.7 19.4H7.3L4.4 10.5L12 5ZM12 2.5L2 9.8L5.8 21.5H18.1L22 9.8L12 2.5Z" fill={color}/>
  </svg>
);

export const FileExportOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const AccountSettingsOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const ArrowBottomRightBoldOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const AccountCogOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const RocketOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const CoffeeOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const ViewGalleryOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
// Continue with more icons... I'll add a selection of the most useful ones
export const ChatPlusOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const FolderSearchOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const TooltipTextOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const HandshakeOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const ClipboardListOutlineIcon: React.FC<MaterialDesignIconProps> = ({ size, color, opacity }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity }}>
...
export const materialDesignIconComponents = {
  'emoticon-cool-outline': EmoticonCoolOutlineIcon,
  'message-badge-outline': MessageBadgeOutlineIcon,
  'map-marker-star-outline': MapMarkerStarOutlineIcon,
  'movie-cog-outline': MovieCogOutlineIcon,
  'star-plus-outline': StarPlusOutlineIcon,
  'pentagon-outline': PentagonOutlineIcon,
  'file-export-outline': FileExportOutlineIcon,
  'account-settings-outline': AccountSettingsOutlineIcon,
  'arrow-bottom-right-bold-outline': ArrowBottomRightBoldOutlineIcon,
  'account-cog-outline': AccountCogOutlineIcon,
  'rocket-outline': RocketOutlineIcon,
  'coffee-outline': CoffeeOutlineIcon,
  'view-gallery-outline': ViewGalleryOutlineIcon,
  'chat-plus-outline': ChatPlusOutlineIcon,
  'folder-search-outline': FolderSearchOutlineIcon,
  'tooltip-text-outline': TooltipTextOutlineIcon,
  'handshake-outline': HandshakeOutlineIcon,
  'clipboard-list-outline': ClipboardListOutlineIcon,
};

export type MaterialDesignIconName = keyof typeof materialDesignIconComponents;
