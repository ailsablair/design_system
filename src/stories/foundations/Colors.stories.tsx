...
export const UsageGuidelines: Story = {
  render: () => (
    <div>
      <h2 style={{ fontSize: '1.5rem', fontWeight: '700', marginBottom: '2rem' }}>Usage Guidelines</h2>
      
      <div style={{ maxWidth: '800px' }}>
        <h3 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '1rem' }}>Accessibility</h3>
        <ul style={{ marginBottom: '2rem', paddingLeft: '1.5rem' }}>
          <li style={{ marginBottom: '0.5rem' }}>All color combinations meet WCAG 2.1 AA contrast requirements</li>
          <li style={{ marginBottom: '0.5rem' }}>Never rely on color alone to convey information</li>
          <li style={{ marginBottom: '0.5rem' }}>Test colors with common color vision deficiencies</li>
        </ul>
        
        <h3 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '1rem' }}>Implementation</h3>
        <p style={{ marginBottom: '1rem' }}>Colors are available as CSS custom properties:</p>
        <pre style={{ 
...
{`.element {
  ...
  color: var(--base-white);
        ...
        <h3 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '1rem' }}>Best Practices</h3>
        <ul style={{ paddingLeft: '1.5rem' }}>
          <li style={{ marginBottom: '0.5rem' }}>Use primary colors sparingly for maximum impact</li>
          <li style={{ marginBottom: '0.5rem' }}>Leverage neutral grays for most interface elements</li>
          <li style={{ marginBottom: '0.5rem' }}>Apply semantic colors consistently for their intended purpose</li>
          <li style={{ marginBottom: '0.5rem' }}>Maintain sufficient contrast ratios for readability</li>
        </ul>
      </div>
    </div>
  ),
