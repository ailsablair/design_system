...
const LoadingIcon = () => (
  <svg width="22" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="loading-spinner">
    <path d="M11.4999 3.66671V1.83337C10.2961 1.83337 9.10414 2.07048 7.99199 2.53115C6.87984 2.99181 5.86931 3.66702 5.01811 4.51823C3.29902 6.23731 2.33325 8.56889 2.33325 11H4.16659C4.16659 9.05512 4.9392 7.18986 6.31447 5.81459C7.68974 4.43932 9.555 3.66671 11.4999 3.66671Z" fill="currentColor"/>
  </svg>
);

/** Primary button component with full state support */
export const PrimaryButton = ({
  ...
  return (
    <button
      type="button"
      className={`primary-button primary-button--${state}`}
      disabled={isDisabled}
      onClick={handleClick}
      {...props}
    >
