          ...
          if (page === 'dots') {
            return (
              <div key={`dots-${index}`} className="table-footer__dots">
                <DotsHorizontalIcon size={size === 'default' ? 24 : 18} />
              </div>
            );
          }
