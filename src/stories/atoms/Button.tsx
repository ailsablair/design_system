...
const CloseCircleIcon: React.FC<{ size: number }> = ({ size }) => {
  if (size === 14) {
    return (
      <svg width={size} height={size} viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g opacity="0.6">
          <path d="M7.00033 1.16669C10.2262 1.16669 12.8337 3.77419 12.8337 7.00002C12.8337 10.2259 10.2262 12.8334 7.00033 12.8334C3.77449 12.8334 1.16699 10.2259 1.16699 7.00002C1.16699 3.77419 3.77449 1.16669 7.00033 1.16669ZM9.09449 4.08335L7.00033 6.17752L4.90616 4.08335L4.08366 4.90585L6.17783 7.00002L4.08366 9.09419L4.90616 9.91669L7.00033 7.82252L9.09449 9.91669L9.91699 9.09419L7.82283 7.00002L9.91699 4.90585L9.09449 4.08335Z" fill="currentColor"/>
        </g>
      </svg>
    );
  } else if (size === 18) {
    return (
      <svg width={size} height={size} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g opacity="0.6">
          <path d="M9 1.5C13.1475 1.5 16.5 4.8525 16.5 9C16.5 13.1475 13.1475 16.5 9 16.5C4.8525 16.5 1.5 13.1475 1.5 9C1.5 4.8525 4.8525 1.5 9 1.5ZM11.6925 5.25L9 7.9425L6.3075 5.25L5.25 6.3075L7.9425 9L5.25 11.6925L6.3075 12.75L9 10.0575L11.6925 12.75L12.75 11.6925L10.0575 9L12.75 6.3075L11.6925 5.25Z" fill="currentColor"/>
        </g>
      </svg>
    );
  } else {
