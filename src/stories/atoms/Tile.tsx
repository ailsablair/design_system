...
// Default alarm icon for the design system
...
export const Tile: React.FC<TileProps> = ({
  ...
  const displayIcon = icon || <AlarmIcon size={iconSize} />;
  ...
  return (
    <div
      className={`tile ${size} ${align} ${colour} ${disabled ? 'disabled' : ''} ${onClick ? 'clickable' : ''} ${className}`}
      onClick={handleClick}
...
// Export default icon for convenience
export { AlarmIcon };
