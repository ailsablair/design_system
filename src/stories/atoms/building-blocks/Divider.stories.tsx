...
export const FigmaDesignShowcase: Story = {
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
              ...
              {/* Title style */}
              <div>
                <h4 style={{ margin: '0 0 24px 0', fontSize: '16px', fontWeight: 500, color: '#333' }}>Title Style</h4>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                  <div>
                    <p style={{ margin: '0 0 12px 0', fontSize: '14px', color: '#666' }}>Left aligned</p>
                    <Divider 
          ...
          <div>
            <h3 style={{ margin: '0 0 32px 0', fontSize: '20px', fontWeight: 600 }}>Vertical with Labels</h3>
            <div style={{ display: 'flex', gap: '60px', justifyContent: 'space-around' }}>
              
              {/* Label-sm style */}
              <div>
                <h4 style={{ margin: '0 0 24px 0', fontSize: '16px', fontWeight: 500, color: '#333', textAlign: 'center' }}>Label Small</h4>
              ...
              {/* Title style */}
              <div>
                <h4 style={{ margin: '0 0 24px 0', fontSize: '16px', fontWeight: 500, color: '#333', textAlign: 'center' }}>Title</h4>
                <div style={{ display: 'flex', gap: '32px', alignItems: 'end' }}>
                  <div style={{ textAlign: 'center' }}>
                    <p style={{ margin: '0 0 12px 0', fontSize: '12px', color: '#666' }}>Top</p>
                    <Divider 
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Complete implementation of the Figma design showcasing all divider variants organized into two component sets: building-blocks/dividers (simple dividers) and divider (labeled dividers with various positioning options).',
      },
    },
  },
};
...
export const BuildingBlocksDividers: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '40px', padding: '20px' }}>
      <h3 style={{ margin: '0', fontSize: '18px', fontWeight: 600 }}>Building-blocks/dividers Component Set</h3>
      
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px' }}>
        <div>
          <h4 style={{ margin: '0 0 16px 0', fontSize: '16px', fontWeight: 500 }}>Horizontal Variants</h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            {(['solid', 'dashed', 'dotted'] as const).map(line => 
              (['0.5px', '1px', '2px', '4px', '8px'] as const).map(thickness => (
                <div key={`${line}-${thickness}`} style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        <div>
          <h4 style={{ margin: '0 0 16px 0', fontSize: '16px', fontWeight: 500 }}>Vertical Variants</h4>
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
            {(['solid', 'dashed', 'dotted'] as const).map(line => 
              (['0.5px', '1px', '2px', '3px', '4px', '8px'] as const).map(thickness => (
                <div key={`${line}-${thickness}`} style={{ display: 'flex', flexDirection: 'column', gap: '8px', alignItems: 'center' }}>
  ...
  parameters: {
    docs: {
      description: {
        story: 'All variants of the building-blocks/dividers component set with different line styles, thicknesses, and alignments.',
      },
    },
  },
};
...
export const LabeledDividers: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '40px', padding: '20px' }}>
      <h3 style={{ margin: '0', fontSize: '18px', fontWeight: 600 }}>Divider Component Set (with labels)</h3>
      
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px' }}>
        <div>
          <h4 style={{ margin: '0 0 24px 0', fontSize: '16px', fontWeight: 500 }}>Horizontal Label Positions</h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
        ...
        <div>
          <h4 style={{ margin: '0 0 24px 0', fontSize: '16px', fontWeight: 500 }}>Vertical Label Positions</h4>
  ...
  parameters: {
    docs: {
      description: {
        story: 'All variants of the divider component set with different label alignments and text styles for both horizontal and vertical orientations.',
      },
    },
  },
};
