...
const FolderIcon: React.FC = () => (
  <svg className="icon-overlay folder-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const ImageIcon: React.FC = () => (
  <svg className="icon-overlay image-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const FilmIcon: React.FC = () => (
  <svg className="icon-overlay film-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const VideoIcon: React.FC = () => (
  <svg className="icon-overlay video-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const AudioIcon: React.FC = () => (
  <svg className="icon-overlay audio-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const PdfIcon: React.FC = () => (
  <svg className="icon-overlay pdf-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const TextIcon: React.FC = () => (
  <svg className="icon-overlay text-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const SheetIcon: React.FC = () => (
  <svg className="icon-overlay sheet-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const CodeIcon: React.FC = () => (
  <svg className="icon-overlay code-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const getBackgroundColor = (type: FileType): string => {
...
export const FileTypeIcon: React.FC<FileTypeIconProps> = ({
  ...
  return (
    <div className={`file-type-icon file-type-icon--${size} file-type-icon--${type} ${className}`.trim()}>
      <svg
        className="page-icon"
        viewBox="0 0 34 42"
        fill="none"
      ...
      {showLabel && label && (
        <div className="file-type-label" style={{ backgroundColor: bgColor }}>
          <span className="file-type-text">{label}</span>
        </div>
      )}
    </div>
  );
