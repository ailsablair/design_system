...
export const AccordionStatus: React.FC<AccordionStatusProps> = ({
  ...
  const renderIcon = () => {
    ...
    switch (type) {
      ...
      case 'locked':
        const lockedPath = size === 'small' 
          ? "M7.99996 11.8334C8.35358 11.8334 8.69272 11.6929 8.94277 11.4429C9.19282 11.1928 9.33329 10.8537 9.33329 10.5001C9.33329 9.76008 8.73329 9.16675 7.99996 9.16675C7.64634 9.16675 7.3072 9.30722 7.05715 9.55727C6.8071 9.80732 6.66663 10.1465 6.66663 10.5001C6.66663 10.8537 6.8071 11.1928 7.05715 11.4429C7.3072 11.6929 7.64634 11.8334 7.99996 11.8334ZM12 5.83341C12.3536 5.83341 12.6927 5.97389 12.9428 6.22394C13.1928 6.47399 13.3333 6.81313 13.3333 7.16675V13.8334C13.3333 14.187 13.1928 14.5262 12.9428 14.7762C12.6927 15.0263 12.3536 15.1667 12 15.1667H3.99996C3.64634 15.1667 3.3072 15.0263 3.05715 14.7762C2.8071 14.5262 2.66663 14.187 2.66663 13.8334V7.16675C2.66663 6.42675 3.26663 5.83341 3.99996 5.83341H4.66663V4.50008C4.66663 3.61603 5.01782 2.76818 5.64294 2.14306C6.26806 1.51794 7.1159 1.16675 7.99996 1.16675C8.4377 1.16675 8.87115 1.25297 9.27557 1.42048C9.67999 1.588 10.0475 1.83353 10.357 2.14306C10.6665 2.45259 10.912 2.82005 11.0796 3.22447C11.2471 3.62889 11.3333 4.06234 11.3333 4.50008V5.83341H12ZM7.99996 2.50008C7.46953 2.50008 6.96082 2.7108 6.58575 3.08587C6.21067 3.46094 5.99996 3.96965 5.99996 4.50008V5.83341H9.99996V4.50008C9.99996 3.96965 9.78925 3.46094 9.41417 3.08587C9.0391 2.7108 8.53039 2.50008 7.99996 2.50008Z"
          : "M14 20.3334C14.6188 20.3334 15.2123 20.0876 15.6499 19.65C16.0875 19.2124 16.3333 18.6189 16.3333 18.0001C16.3333 16.7051 15.2833 15.6667 14 15.6667C13.3811 15.6667 12.7876 15.9126 12.35 16.3502C11.9125 16.7878 11.6666 17.3812 11.6666 18.0001C11.6666 18.6189 11.9125 19.2124 12.35 19.65C12.7876 20.0876 13.3811 20.3334 14 20.3334ZM21 9.83341C21.6188 9.83341 22.2123 10.0792 22.6499 10.5168C23.0875 10.9544 23.3333 11.5479 23.3333 12.1667V23.8334C23.3333 24.4523 23.0875 25.0457 22.6499 25.4833C22.2123 25.9209 21.6188 26.1667 21 26.1667H6.99996C6.38112 26.1667 5.78763 25.9209 5.35004 25.4833C4.91246 25.0457 4.66663 24.4523 4.66663 23.8334V12.1667C4.66663 10.8717 5.71663 9.83341 6.99996 9.83341H8.16663V7.50008C8.16663 5.95298 8.78121 4.46925 9.87517 3.37529C10.9691 2.28133 12.4529 1.66675 14 1.66675C14.766 1.66675 15.5245 1.81763 16.2323 2.11078C16.94 2.40394 17.5831 2.83362 18.1248 3.37529C18.6664 3.91697 19.0961 4.56003 19.3893 5.26776C19.6824 5.97549 19.8333 6.73404 19.8333 7.50008V9.83341H21ZM14 4.00008C13.0717 4.00008 12.1815 4.36883 11.5251 5.02521C10.8687 5.68158 10.5 6.57182 10.5 7.50008V9.83341H17.5V7.50008C17.5 6.57182 17.1312 5.68158 16.4748 5.02521C15.8185 4.36883 14.9282 4.00008 14 4.00008Z";
          ...
          <div className="accordion__status-circle">
            ...
            >
              {disabled ? (
                ...
                <path d={commentsPath} fill="#B6E5F9"/>
              )}
            </svg>
          </div>
        );
        ...
        return (
          <div className="accordion__status-circle">
            <svg 
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d={notificationsPath} fill={notificationsFill}/>
            </svg>
          </div>
        );
          ...
          <div className="accordion__status-circle">
            ...
            >
              <g opacity={errorOpacity}>
                <path d={errorPath} fill={errorFill}/>
              </g>
            </svg>
          </div>
        );
      ...
      case 'note':
        ...
        const notePath = size === 'small'
          ? "M7.58337 5.74984H10.7917L7.58337 2.5415V5.74984ZM3.50004 1.6665H8.16671L11.6667 5.1665V12.1665C11.6667 12.4759 11.5438 12.7727 11.325 12.9915C11.1062 13.2103 10.8095 13.3332 10.5 13.3332H3.50004C2.85254 13.3332 2.33337 12.8082 2.33337 12.1665V2.83317C2.33337 2.18567 2.85254 1.6665 3.50004 1.6665ZM8.75004 10.9998V9.83317H3.50004V10.9998H8.75004ZM10.5 8.6665V7.49984H3.50004V8.6665H10.5Z"
          : "M15.1666 11.0002H21.5833L15.1666 4.5835V11.0002ZM6.99996 2.8335H16.3333L23.3333 9.8335V23.8335C23.3333 24.4523 23.0875 25.0458 22.6499 25.4834C22.2123 25.921 21.6188 26.1668 21 26.1668H6.99996C5.70496 26.1668 4.66663 25.1168 4.66663 23.8335V5.16683C4.66663 3.87183 5.70496 2.8335 6.99996 2.8335ZM17.5 21.5002V19.1668H6.99996V21.5002H17.5ZM21 16.8335V14.5002H6.99996V16.8335H21Z";
        const noteOpacity = disabled ? "1" : "0.4";
        const noteFill = disabled ? "#D2D5DA" : "#5D2C82";
