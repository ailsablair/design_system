...
<Canvas>
  <Story name="Size Variations">
    <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
      <div>
        <h4 style={{ margin: '0 0 8px 0', fontSize: '12px', color: '#666' }}>Small</h4>
        <DropdownMenu 
          items={[
            { label: 'Menu item', showLeadingIcon: true },
            { label: 'Menu item', showLeadingIcon: true },
      ...
      <div>
        <h4 style={{ margin: '0 0 8px 0', fontSize: '12px', color: '#666' }}>Large</h4>
        <DropdownMenu 
          items={[
            { label: 'Menu item', showLeadingIcon: true },
            { label: 'Menu item', showLeadingIcon: true },
...
| `type` | `'simple' \| 'back' \| 'section' \| 'sub-section'` | `'simple'` | Item type |
