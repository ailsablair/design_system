import { Meta, Story, Canvas, ArgTypes, Description } from '@storybook/blocks';
import { DataTable } from './DataTable';

<Meta 
  title="Molecules/DataTable/Documentation" 
  component={DataTable}
  parameters={{
    docs: {
      description: {
        component: 'Comprehensive documentation for the DataTable component'
      }
    }
  }}
/>
